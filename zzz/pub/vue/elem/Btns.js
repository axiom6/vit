...
const _withId = /*#__PURE__*/withScopeId("data-v-6583f150");

pushScopeId("data-v-6583f150");
const _hoisted_1 = {
  ref: "Btns",
  class: "btns-pane"
};
const _hoisted_2 = { class: "btns-center" };
popScopeId();

const render = /*#__PURE__*/_withId((_ctx, _cache, $props, $setup, $data, $options) => {
  return (openBlock(), createBlock("div", _hoisted_1, [
    (openBlock(true), createBlock(Fragment, null, renderList(_ctx.btns, (btn) => {
      return (openBlock(), createBlock("div", {
        ref: btn.name,
        style: _ctx.styleBlock(btn.pos)
      }, [
        createVNode("div", _hoisted_2, [
          createVNode("div", {
            class: "btns-btn",
            style: _ctx.styleBtn(btn),
            onClick: $event => (_ctx.pubBtn(btn))
          }, [
            (btn.check)
              ? (openBlock(), createBlock("span", {
                  key: 0,
                  class: _ctx.classCheck(btn)
                }, null, 2 /* CLASS */))
              : createCommentVNode("v-if", true),
            (btn.icon)
              ? (openBlock(), createBlock("i", {
                  key: 1,
                  class: _ctx.classIcons(btn)
                }, null, 2 /* CLASS */))
              : createCommentVNode("v-if", true),
            (btn.img)
            ...
            (btn.title)
              ? (openBlock(), createBlock("span", {
                  key: 3,
                  class: "title",
                  ref: _ctx.titleRef(btn)
                }, toDisplayString(btn.title), 513 /* TEXT, NEED_PATCH */))
              : createCommentVNode("v-if", true)
...
Btns.render = render;
Btns.__scopeId = "data-v-6583f150";
Btns.__file = "vue/elem/Btns.vue";
