...
const _withId = /*#__PURE__*/withScopeId("data-v-2cfc00cc");

pushScopeId("data-v-2cfc00cc");
const _hoisted_1 = {
  key: 0,
  class: "item-icon"
};
...
const render = /*#__PURE__*/_withId((_ctx, _cache, $props, $setup, $data, $options) => {
  return (openBlock(), createBlock("div", {
    ...
    createVNode("div", {
      class: "item-line",
      onClick: _cache[1] || (_cache[1] = $event => (_ctx.doClick()))
    }, [
      (_ctx.hasProp('icon'))
      ...
      (_ctx.hasProp('name'))
        ? (openBlock(), createBlock("span", _hoisted_2, toDisplayString(_ctx.name), 1 /* TEXT */))
        : createCommentVNode("v-if", true),
      (_ctx.hasProp('desc'))
        ? (openBlock(), createBlock("span", _hoisted_3, toDisplayString(_ctx.desc), 1 /* TEXT */))
        : createCommentVNode("v-if", true)
    ])
  ], 4 /* STYLE */))
});
...
Item.render = render;
Item.__scopeId = "data-v-2cfc00cc";
Item.__file = "vue/elem/Item.vue";
