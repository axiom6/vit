...
const _withId = /*#__PURE__*/withScopeId("data-v-9c6ee892");
...
const render = /*#__PURE__*/_withId((_ctx, _cache, $props, $setup, $data, $options) => {
  return (openBlock(), createBlock("div", {
    ...
    (openBlock(true), createBlock(Fragment, null, renderList(_ctx.pages, (pageObj) => {
      return (openBlock(), createBlock("div", {
        class: _ctx.classTab(pageObj.key),
        onClick: $event => (_ctx.doPage(pageObj.key))
      }, toDisplayString(pageObj.title), 11 /* TEXT, CLASS, PROPS */, ["onClick"]))
    }), 256 /* UNKEYED_FRAGMENT */))
  ], 4 /* STYLE */))
});

Tabs.render = render;
Tabs.__scopeId = "data-v-9c6ee892";
Tabs.__file = "vue/elem/Tabs.vue";
